...
public class BuffFSM_CON : MonoBehaviour
{
    // The Current State
    private BuffBaseState state;
    ...
    void Start()
    {
        ...
        BuffBaseState _BuffIdleState  = new BuffIdleState(this.gameObject);
        
        // set the default / start state
        state = _BuffIdleState ;
    ...
    void Update()
    {
        ...
        BuffBaseState newState = state.HandleInput(this.gameObject);
