...
public class LaneFSM_CON : MonoBehaviour
{
    // The Current State
    private LaneBaseState state;
    ...
    void Start()
    {
        ...
        LaneBaseState _LaneIdleState  = new LaneIdleState(this.gameObject);
        
        // set the default / start state
        state = _LaneIdleState ;
    ...
    void Update()
    {
        ...
        LaneBaseState newState = state.HandleInput(this.gameObject);
