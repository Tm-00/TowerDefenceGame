...
public class ScoutFSM_CON : MonoBehaviour
{
    // The Current State
    private ScoutBaseState state;
    ...
    void Start()
    {
        ...
        ScoutBaseState _ScoutIdleState  = new ScoutIdleState(this.gameObject);
        
        // set the default / start state
        state = _ScoutIdleState ;
    ...
    void Update()
    {
        ...
        ScoutBaseState newState = state.HandleInput(this.gameObject);
